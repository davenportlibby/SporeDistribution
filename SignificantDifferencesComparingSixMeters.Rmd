...
bb6.mean <- mean(bb6$Concentration)

###percent increase
bb.diff <- (((bb6.mean-bb.mean)/bb.mean)*100)
bb.diff
```
...
bo6.mean <- mean(bo6$Concentration)

###percent increase
bo.diff <- (((bo6.mean-bo.mean)/bo.mean)*100)
bo.diff
```
